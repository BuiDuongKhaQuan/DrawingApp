...
public class Triangle extends Shape {
	...
	void move(MouseEvent e, Shape selectedShape) {
		...
		int[] xPoints = { (((Triangle) selectedShape).gettX() + width / 2), ((Triangle) selectedShape).gettX(),
				(((Triangle) selectedShape).gettX() + width) };
		int[] yPoints = { ((Triangle) selectedShape).gettY(), (((Triangle) selectedShape).gettY() + hight),
